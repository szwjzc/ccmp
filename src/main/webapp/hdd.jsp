  ...
  <div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="last active "><a href="hdd.jsp"> <i
          ...
          <div class="pane">
            <div class="toolbar">
              <a class="btn" href="#"><span
                ...
                class="icon icon-create"></span><span class="text">创建</span></a>
              <div class="dropdown btn-disabled">
                ...
                <div class="dropdown-content">
                  <a class="btn btn-forbidden" href="#"><span
                    ...
                    class="icon icon-instances"></span><span
                    class="text">加载硬盘到主机</span></a><a
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-delete"></span><span class="text">卸载硬盘</span></a><a
                    class="btn btn-forbidden" href="#"><span
                ...
                <tr>
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-content">
                        <a href="#" data-filter="status"
                          data-status="available,in-use,suspended">全部</a><a
                          href="#" data-filter="status"
                          data-status="available">可用</a><a href="#"
                          data-filter="status" data-status="in-use">使用中</a><a
                          href="#" data-filter="status"
                          data-status="suspended">已暂停</a><a href="#"
                          data-filter="status"
                          data-status="deleted,ceased">已删除</a>
                      </div>
                    </div>
                  </th>
                  <th>主机</th>
                  ...
                  <th>类型
                    <div class="dropdown">
                      ...
                      <div class="dropdown-text"></div>
                      <div class="dropdown-content">
                        <a href="#" data-filter="volume_type"
                          data-filter-type="int" data-volume_type="">类型</a><a
                          href="#" data-filter="volume_type"
                          data-filter-type="int" data-volume_type="0">性能型</a><a
                          href="#" data-filter="volume_type"
                          data-filter-type="int" data-volume_type="1">容量型</a>
                      </div>
                    </div>
                  </th>
                  <th>距离上次备份时间</th>
