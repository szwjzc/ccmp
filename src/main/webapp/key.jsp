  ...
  <div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="last active "><a href="key.jsp"> <i
        ...
        <div class="row-fluid">
          ...
          <div class="span12">
            ...
            <h3 class="page-title">
              ...
              SSH Key <small>对云主机的身份认证管理</small>
          ...
          <div class="pane">
            <div class="toolbar">
              <a class="btn" href="#"><span
                ...
                class="icon icon-create"></span><span class="text">创建</span></a><a
                class="btn btn-forbidden" href="#"><span
                class="icon icon-keypairs"></span><span class="text">加载到主机</span></a>
                ...
                <tr>
                  ...
                  <th>加密方法
                    <div class="dropdown">
                      ...
                      <div class="dropdown-content">
                        <a href="#" data-filter="encrypt_method"
                          data-encrypt_method="ssh-rsa,ssh-dss">全部</a><a
                          href="#" data-filter="encrypt_method"
                          data-encrypt_method="ssh-rsa">ssh-rsa</a><a
                          href="#" data-filter="encrypt_method"
                          data-encrypt_method="ssh-dss">ssh-dss</a>
                      </div>
                    </div>
                  </th>
                  <th>创建时间</th>
