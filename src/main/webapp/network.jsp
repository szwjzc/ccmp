  ...
  <div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="last active "><a href="network.jsp"> <i
        ...
        <div class="row-fluid">
          ...
          <div class="span12">
            ...
            <h3 class="page-title">
              ...
              Network <small>配置与查看虚拟网络情况</small>
              ...
              <div class="dropdown btn-disabled">
                ...
                <div class="dropdown-content">
                  <a class="btn btn-forbidden" href="#"><span
                    ...
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-power-off"></span><span
                    class="text">关闭</span></a><a
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-content">
                        <a href="#" data-filter="status"
                          ...
                          data-filter="status" data-status="pending">等待中</a><a
                          href="#" data-filter="status"
