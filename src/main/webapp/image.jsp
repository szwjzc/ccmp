  ...
  <div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="last active "><a href="image.jsp"> <i
        ...
        <div class="row-fluid">
          ...
          <div class="span12">
            ...
            <h3 class="page-title">
              ...
              Images <small>用于创建云主机的镜像文件</small>
        ...
        <div id="dashboard">
          <div class="pane">
            <div class="toolbar">
              ...
              <div class="dropdown btn-disabled">
                ...
                <div class="dropdown-content">
                  <a class="btn btn-danger btn-forbidden" href="#"><span
                    class="icon icon-delete"></span><span class="text">删除</span></a>
                </div>
              </div>
              ...
              <div class="pagination">
                <span class="current">每页&nbsp;<input type="text"
                  name="limit" class="tiny" value="10">&nbsp;页数
                  1 / 3
                </span><a class="btn prev btn-forbidden" data-direction="prev"><span
                  class="icon-prev" data-direction="prev"></span></a><a
                  class="btn next btn-" data-direction="next"><span
                  class="icon-next" data-direction="next"></span></a>
              </div>
            </div>
            <table class="table table-bordered table-hover">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-content">
                        <a href="#" data-filter="status"
                          data-status="available,deprecated">全部</a><a
                          href="#" data-filter="status"
                          data-status="available">可用</a><a href="#"
                          data-filter="status" data-status="deprecated">已弃用</a>
                      </div>
                    </div>
                  </th>
                  <th>容量 (G)</th>
              ...
              <tbody>
                <tr id="arch201310x64a">
                  <td><a class="id"
                    href="/console/images/arch201310x64a/"
                    data-permalink="">arch201310x64a</a></td>
                  <td>Arch Linux 2013.10 64bit</td>
                  <td class="available"><span
                    class="icon-status icon-available"></span>&nbsp; 可用</td>
                  <td>20</td>
                  <td>linux</td>
                </tr>
                <tr id="centos58x86a">
                  <td><a class="id"
                    href="/console/images/centos58x86a/"
                    data-permalink="">centos58x86a</a></td>
                  <td>CentOS 5.8 32bit</td>
                  <td class="available"><span
                    class="icon-status icon-available"></span>&nbsp; 可用</td>
                  <td>20</td>
                  <td>linux</td>
                ...
                <tr id="centos58x64a">
                  <td><a class="id"
                    href="/console/images/centos58x64a/"
                    data-permalink="">centos58x64a</a></td>
                  <td>CentOS 5.8 64bit</td>
                  <td class="available"><span
                    class="icon-status icon-available"></span>&nbsp; 可用</td>
                  <td>20</td>
                  <td>linux</td>
                ...
                <tr id="centos63x64a">
                  <td><a class="id"
                    href="/console/images/centos63x64a/"
                    data-permalink="">centos63x64a</a></td>
                ...
                <tr id="centos64x86a">
                  <td><a class="id"
                    href="/console/images/centos64x86a/"
                    data-permalink="">centos64x86a</a></td>
                  <td>CentOS 6.4 32bit</td>
                  <td class="available"><span
                    class="icon-status icon-available"></span>&nbsp; 可用</td>
                  <td>20</td>
                  <td>linux</td>
                ...
                <tr id="centos64x64b">
                  <td><a class="id"
                    href="/console/images/centos64x64b/"
                    data-permalink="">centos64x64b</a></td>
                  <td>CentOS 6.4 64bit</td>
                  <td class="available"><span
                    class="icon-status icon-available"></span>&nbsp; 可用</td>
                  <td>20</td>
                  <td>linux</td>
                ...
                <tr id="centos65x64b">
                  <td><a class="id"
                    href="/console/images/centos65x64b/"
                    data-permalink="">centos65x64b</a></td>
                ...
                <tr id="centos7x64">
                  <td><a class="id"
                    href="/console/images/centos7x64/" data-permalink="">centos7x64</a></td>
                ...
                <tr id="wheezyx86b">
                  <td><a class="id"
                    href="/console/images/wheezyx86b/" data-permalink="">wheezyx86b</a></td>
                  <td>Debian Wheezy 7.1 32bit</td>
                  <td class="available"><span
                    class="icon-status icon-available"></span>&nbsp; 可用</td>
                  <td>20</td>
                  <td>linux</td>
                ...
                <tr id="wheezyx64c">
                  <td><a class="id"
                    href="/console/images/wheezyx64c/" data-permalink="">wheezyx64c</a></td>
                  <td>Debian Wheezy 7.1 64bit</td>
                  <td class="available"><span
                    class="icon-status icon-available"></span>&nbsp; 可用</td>
                  <td>20</td>
                  <td>linux</td>
