  ...
  <div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="last active "><a href="ipaddr.jsp"> <i
        ...
        <div class="row-fluid">
          ...
          <div class="span12">
            ...
            <h3 class="page-title">
              ...
              Ipaddress <small>查看IP绑定与分配情况</small>
          ...
          <div class="pane">
            <div class="toolbar">
              <a class="btn" href="#"><span
                ...
                class="icon icon-allocate"></span><span class="text">申请</span></a>
              <div class="dropdown btn-disabled">
                ...
                <div class="dropdown-content">
                  <a class="btn btn-forbidden" href="#"><span
                    ...
                    class="icon icon-modify"></span><span class="text">设置ICP备案信息</span></a><a
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-instance"></span><span class="text">分配到主机</span></a><a
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-router"></span><span class="text">分配到路由器</span></a><a
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-loadbalancer"></span><span
                    class="text">分配到负载均衡器</span></a><a
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-dissociate"></span><span
                    class="text">解绑</span></a><a class="btn btn-forbidden"
                    href="#"><span class="icon icon-bandwidth"></span><span
                    class="text">调整公网IP带宽</span></a><a
                    class="btn btn-danger btn-forbidden" href="#"><span
                    class="icon icon-release"></span><span class="text">删除</span></a>
                </div>
              </div>
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-content">
                        <a href="#" data-filter="status"
                          data-status="pending,available,associated,suspended">全部</a><a
                          href="#" data-filter="status"
                          data-status="pending">等待中</a><a href="#"
                          data-filter="status" data-status="available">可用</a><a
                          href="#" data-filter="status"
                          data-status="associated">已分配</a><a href="#"
                          data-filter="status" data-status="suspended">已暂停</a><a
                          href="#" data-filter="status"
                          data-status="released,ceased">已删除</a>
                      </div>
                    </div>
                  </th>
                  <th>资源</th>
