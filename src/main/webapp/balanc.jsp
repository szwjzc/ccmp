  ...
  <div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="last active "><a href="balanc.jsp"> <i
        ...
        <div class="row-fluid">
          ...
          <div class="span12">
            ...
            <h3 class="page-title">
              ...
              Balanc <small>实现多云主机进行负载均衡</small>
              ...
              <div class="dropdown btn-disabled">
                ...
                <div class="dropdown-content">
                  <a class="btn btn-forbidden" href="#"><span
                    ...
                    class="icon icon-loadbalancers"></span><span
                    class="text">应用修改</span></a><a class="btn btn-forbidden"
                    href="#"><span class="icon icon-eip"></span><span
                    class="text">绑定公网IP</span></a><a
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-start"></span><span class="text">启动</span></a><a
                    class="btn btn-forbidden" href="#"><span
                    class="icon icon-stop"></span><span class="text">关机</span></a><a
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-content">
                        <a href="#" data-filter="status"
                          data-status="active,pending,suspended">全部</a><a
                          href="#" data-filter="status"
                          data-status="active">活跃</a><a href="#"
                          data-filter="status" data-status="stopped">已关机</a><a
                          href="#" data-filter="status"
